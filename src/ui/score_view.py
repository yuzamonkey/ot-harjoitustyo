  ...
  def _show_score(self):
    ...
    for i in range (measure_count):
      ...
      for notation in measure.get_notations():
        if (notation.is_note()):
          canvas.create_image(notation_position, 80, image=self._half_note, anchor=tk.constants.NW)
          notation_position += notation_gap
      if i == measure_count-1:
        break
      canvas.create_line(notation_position+25, 125, notation_position+25, 225)
