...
class TestMaksukortti(unittest.TestCase):
  ...
  def test_negatiivisen_summan_lataamien_ei_muuta_kortin_saldoa(self):
    self.kortti.lataa_rahaa(-5)
    self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

  def test_edullinen_lounas_kun_kortilla_edullinen_maara_rahaa(self):
    self.kortti.syo_edullisesti()
    self.kortti.syo_edullisesti()
    self.kortti.syo_edullisesti()
    self.kortti.syo_edullisesti()
  ...
  def test_maukas_lounas_kun_kortilla_maukas_maara_rahaa(self):
